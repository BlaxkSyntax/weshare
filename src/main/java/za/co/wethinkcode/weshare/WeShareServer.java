...
public class WeShareServer {
    ...
    private static void settlementRoutes() {
        path(SettlementViewController.EXPENSE_PATH, () -> get(SettlementViewController:: renderSettleClaimForm));
        post(SettlementViewController.EXPENSE_PATH, SettlementViewController::submitSettlement);
    }
